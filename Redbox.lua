...
function Script()
    local Window = Library.CreateLib("Redbox Script", "Synapse")
    ...
    MainSection:NewButton("Chams Esp", "Lets you see ppl through walls", function()
        loadstring(game:HttpGet(('https://raw.githubusercontent.com/YeetPlayz/roblox-chams/main/test.lua'),true))()
    end)
    ...
    CreditsSection:NewLabel("Created by Corrupted#9560")
    


end

if game.PlaceId == 10243982775 then
    Script()
end
	end
end)
